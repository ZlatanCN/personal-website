    ...
    <SectionContainer>
      ...
      <article>
        ...
        >
          ...
          <div
            className={
              'grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0 dark:divide-gray-700'
            }
          >
            <dl
              className={
            ...
            >
              ...
              {siteMetadata.comments && (
                <div
                  className={
                    'pt-6 pb-6 text-center text-gray-700 dark:text-gray-300'
                  }
                  id={'comment'}
                >
                  <Comments slug={slug} />
            ...
            <footer>
              <div
                className={
                  'divide-gray-200 text-sm leading-5 font-medium xl:col-start-1 xl:row-start-2 xl:divide-y dark:divide-gray-700'
                }
              >
                {tags && (
