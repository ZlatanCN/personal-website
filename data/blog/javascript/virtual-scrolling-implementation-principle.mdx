...
> 
> ![Without translateY](/static/images/virtual-scrolling-implementation-principle/without-translateY.gif)
> 
> 设置 `transform: translateY(scrollTop)` 的作用是，在滚动的同时，将内容列表容器**向下推**，其向下的距离**恰好等于**容器向上滚动的距离。这一“推”一“滚”相互抵消，使得用户看到的列表项在视觉上保持在了正确的位置。
> 
> ![With translateY](/static/images/virtual-scrolling-implementation-principle/with-translateY.gif)
